...
type LocalConfigController interface {
	...
	AddHandler(handler LocalConfigHandlerFunc)
...
type LocalConfigInterface interface {
	...
	GetNamespace(name, namespace string, opts metav1.GetOptions) (*LocalConfig, error)
	...
	AddSyncHandler(sync LocalConfigHandlerFunc)
...
func (c *localConfigController) AddHandler(handler LocalConfigHandlerFunc) {
...
func (s *localConfigClient) GetNamespace(name, namespace string, opts metav1.GetOptions) (*LocalConfig, error) {
...
func (s *localConfigClient) DeleteNamespace(name, namespace string, options *metav1.DeleteOptions) error {
...
func (s *localConfigClient) AddSyncHandler(sync LocalConfigHandlerFunc) {
	s.Controller().AddHandler(sync)
}

func (s *localConfigClient) AddLifecycle(name string, lifecycle LocalConfigLifecycle) {
	sync := NewLocalConfigLifecycleAdapter(name, s, lifecycle)
