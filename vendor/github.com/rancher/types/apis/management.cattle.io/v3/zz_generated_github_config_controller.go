...
type GithubConfigController interface {
	...
	AddHandler(handler GithubConfigHandlerFunc)
...
type GithubConfigInterface interface {
	...
	GetNamespace(name, namespace string, opts metav1.GetOptions) (*GithubConfig, error)
	...
	AddSyncHandler(sync GithubConfigHandlerFunc)
...
func (c *githubConfigController) AddHandler(handler GithubConfigHandlerFunc) {
...
func (s *githubConfigClient) GetNamespace(name, namespace string, opts metav1.GetOptions) (*GithubConfig, error) {
...
func (s *githubConfigClient) DeleteNamespace(name, namespace string, options *metav1.DeleteOptions) error {
...
func (s *githubConfigClient) AddSyncHandler(sync GithubConfigHandlerFunc) {
	s.Controller().AddHandler(sync)
}

func (s *githubConfigClient) AddLifecycle(name string, lifecycle GithubConfigLifecycle) {
	sync := NewGithubConfigLifecycleAdapter(name, s, lifecycle)
